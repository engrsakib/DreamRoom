...
class Room(Object3D):
    def __init__(self, cube_mesh):
        super().__init__()
        material = Material(settings.WALL_COLOR, specular_strength=0.1, shininess=8.0)
        floor_material = Material(settings.FLOOR_COLOR, specular_strength=0.15, shininess=8.0)
